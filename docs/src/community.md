...
- Some additional code snippets have been adapted into Transmogrifier from the following repositories (search for their names in Transmogrifier's [repository](https://github.com/sawyerrensel/Transmogrifier) to view the specific adaptations):
